...
class RAGEngine:
    ...
    def query(self, user_query: str, session_id: str):
        ...
        final_prompt = (
            ...
            "STRUCTURE RULES FOR YOUR ANSWER:\n"
            "- ALWAYS organize your response using clear Markdown formatting.\n"
            "- Use headings (e.g., '### Heading' or '#### Heading') to separate distinct sections or main ideas.\n"
            "- Use clean bulleted lists ('* Item') or numbered lists ('1. Item') when outlining points, methods, or details.\n"
            "- Be consistent: DO NOT mix styles (e.g. do not mix bolded list items without bullets and bulleted list items together).\n"
            "- Use double newlines between paragraphs and block elements to ensure clean spacing.\n\n"
